...
public class LoginPageTest extends TestBase {
    ...
    public void testLogin() {
        ...
        try {
            ...
            assertNotNull("Login failed: header not visible.", header);
            System.out.println("----- Login test passed. -----");

        } catch (TimeoutException e) {
            fail("Login failed: header not found after waiting.");
        }
    }
    ...
    public void testLogout() throws Exception {
        ...
        try {
            ...
            WebElement emailField = longWait.until(ExpectedConditions.visibilityOfElementLocated(
                By.id("email_input")
            ));
