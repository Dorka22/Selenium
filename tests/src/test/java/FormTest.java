...
public class FormTest extends TestBase {
    ...
    public void formTest() throws Exception {
        ...
        WebElement nameInput = driver.findElement(By.cssSelector("input[placeholder='Munka megnevezése']"));
        nameInput.clear();
        nameInput.sendKeys("teszt");
        System.out.println("Log name written into the field.");

        WebElement descriptionInput = driver.findElement(By.cssSelector("input[placeholder='Munka leírása']"));
        descriptionInput.clear();
        descriptionInput.sendKeys("teszt leírás hosszan");
        ...
        assertTrue("Work button should be clickable again", isClickable);
